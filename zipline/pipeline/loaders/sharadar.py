...
class SharadarFundamentalsPipelineLoader(PipelineLoader):
...
class SharadarInstitutionsPipelineLoader(PipelineLoader):
...
class SharadarSP500PipelineLoader(PipelineLoader):
