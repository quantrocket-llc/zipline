...
from zipline._testing.core import parameter_space, powerset
from zipline._testing.predicates import assert_equal, assert_messages_equal
...
class DataQueryCutoffForSessionTestCase(zf.ZiplineTestCase):
    ...
    def test_built_in_equity_calendar_domain_defaults(self):
        ...
        expected_cutoff_times = {
            ...
            DE_EQUITIES_XDUS: datetime.time(7, 15),
            DE_EQUITIES_XHAM: datetime.time(7, 15),
            ...
            XEEE_FUTURES: datetime.time(7, 15),
